...
inline vec3 operator*(const float& s, const vec3& v) { return vec3(v.x * s, v.y * s, v.z * s); }
inline vec3 operator*(const vec3& v, const float& s) { return vec3(v.x * s, v.y * s, v.z * s); }
...
inline vec4 operator*(const vec4& b, const mat4& a)
{
    return vec4(a.cell[0] * b.x + a.cell[1] * b.y + a.cell[2] * b.z + a.cell[3] * b.w,
                a.cell[4] * b.x + a.cell[5] * b.y + a.cell[6] * b.z + a.cell[7] * b.w,
                a.cell[8] * b.x + a.cell[9] * b.y + a.cell[10] * b.z + a.cell[11] * b.w,
...
inline mat4 mat4::rotate(const vec3 l, const float a)
{
...
inline mat4 mat4::rotatex(const float a)
{
    mat4 M;
...
inline mat4 mat4::rotatey(const float a)
{
    mat4 M;
    const float ca = cosf(a), sa = sinf(a);
...
inline mat4 mat4::rotatez(const float a)
{
    mat4 M;
    const float ca = cosf(a), sa = sinf(a);
